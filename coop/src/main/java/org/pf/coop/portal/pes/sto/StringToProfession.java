...
@Component
public class StringToProfession implements Converter<String, Profession>{
	...
	public Profession convert(String source) {
		try {
			Optional<Profession> optionalEntity = repo.findById(Long.valueOf(Long.parseLong(source)));
