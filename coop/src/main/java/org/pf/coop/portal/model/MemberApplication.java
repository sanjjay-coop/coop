...
@Table(name="tab_member_application")
public class MemberApplication extends BaseObject implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1036405278150089084L;

	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator = "key_member_application")
	@SequenceGenerator(name="key_member_application", 
		sequenceName="seq_key_member_application",
		allocationSize=1)
	private Long id;
	...
	@Column(name="f_status_date", nullable=false)
	...
	public String toString() {
		return "MemberApplication [" + (id != null ? "id=" + id + ", " : "")
