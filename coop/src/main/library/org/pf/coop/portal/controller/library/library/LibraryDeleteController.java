...
@Controller
@RequestMapping("/library/library/delete")
public class LibraryDeleteController extends LibraryBaseController {
	...
	public String deleteLibrary(@PathVariable Long id, Model model,
		...
		try {
			...
			TransactionResult tr = this.libraryService.deleteLibrary(id, principal.getName());
