...
public class JobListAllController extends HomeBaseController {
	...
	public String listJob(@ModelAttribute Job job, Model model, RedirectAttributes reat, Principal principal, HttpServletRequest request) {
		...
		try {
			...
			request.getSession().setAttribute("homeSearchAll_job", job);
	...
	public String listJob(Model model, RedirectAttributes reat, Principal principal, HttpServletRequest request) {
		...
		Job obj = (Job) request.getSession().getAttribute("homeSearchAll_job");
		...
		request.getSession().setAttribute("homeSearchAll_job", obj);
		...
		request.getSession().setAttribute("listJobAll_pageNumber", this.pageNumber);
		request.getSession().setAttribute("listJobAll_totalPages", this.totalPages);
	...
	public String listJob(@PathVariable String whichPage, Model model, Principal principal, HttpServletRequest request) {
		...
		try {
			this.pageNumber = (int) request.getSession().getAttribute("listJobAll_pageNumber");
			this.totalPages = (int) request.getSession().getAttribute("listJobAll_totalPages");
