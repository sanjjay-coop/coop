...
@Controller
@RequestMapping("/home/business/all")
public class BusinessListAllController extends HomeBaseController {
	...
	public String listBusiness(@ModelAttribute Business business, Model model, RedirectAttributes reat, Principal principal, HttpServletRequest request) {
		...
		try {
			...
			request.getSession().setAttribute("homeSearchAll_business", business);
	...
	public String listBusiness(Model model, RedirectAttributes reat, Principal principal, HttpServletRequest request) {
		...
		Business obj = (Business) request.getSession().getAttribute("homeSearchAll_business");
		...
		request.getSession().setAttribute("homeSearchAll_business", obj);
		...
		request.getSession().setAttribute("listBusinessAll_pageNumber", this.pageNumber);
		request.getSession().setAttribute("listBusinessAll_totalPages", this.totalPages);
	...
	public String listBusiness(@PathVariable String whichPage, Model model, Principal principal, HttpServletRequest request) {
		...
		try {
			this.pageNumber = (int) request.getSession().getAttribute("listBusinessAll_pageNumber");
			this.totalPages = (int) request.getSession().getAttribute("listBusinessAll_totalPages");
