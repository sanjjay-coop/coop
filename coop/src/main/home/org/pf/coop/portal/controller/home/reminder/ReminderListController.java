...
@Controller
@RequestMapping("/home/reminder")
public class ReminderListController extends HomeBaseController {
	...
	public String listReminder(@PathVariable String whichPage, Model model, Principal principal, HttpServletRequest request) {
		...
		try {
			...
			if ("previous".equals(whichPage)) {
				if (pageNumber == 0) return "redirect:/home/reminder/list";
				else {
					pageNumber--; 
				}
