...
@Controller
@RequestMapping("/home/serviceProvider")
public class ServiceProviderListController extends HomeBaseController {
	...
	public String listServiceProvider(Model model, Principal principal, HttpServletRequest request) {
		...
		return "home/serviceProvider/list";
	}
	...
	public String listServiceProvider(@PathVariable String whichPage, Model model, Principal principal, HttpServletRequest request) {
		...
		try {
			...
			if ("previous".equals(whichPage)) {
				if (pageNumber == 0) return "redirect:/home/serviceProvider/list";
				else {
					pageNumber--; 
				}
