...
@Controller
@RequestMapping("/mobile/open/gallery/view")
public class MobileOpenGalleryViewController extends BaseController{
	...
	public String editGallery(@PathVariable Long id, Model model,
		...
		try {
			...
			if (gallery == null) {
				...
				return "redirect:/mobile/open/gallery/list/current";
			}
			...
			return "mobile/open/gallery/view";
		} catch (Exception e) {
