...
public class MobileHomeServiceProviderListController extends MobileBaseController {
	...
	public String listServiceProvider(@ModelAttribute ServiceProvider serviceProvider, Model model, RedirectAttributes reat, Principal principal, HttpServletRequest request) {
		...
		try {
			...
			request.getSession().setAttribute("mobileSearch_serviceProvider", serviceProvider);
	...
	public String listServiceProvider(Model model, RedirectAttributes reat, Principal principal, HttpServletRequest request) {
		...
		ServiceProvider obj = (ServiceProvider) request.getSession().getAttribute("mobileSearch_serviceProvider");
		...
		request.getSession().setAttribute("mobileSearch_serviceProvider", obj);
		...
		request.getSession().setAttribute("listMobileServiceProvider_pageNumber", this.pageNumber);
		request.getSession().setAttribute("listMobileServiceProvider_totalPages", this.totalPages);
	...
	public String listServiceProvider(@PathVariable String whichPage, Model model, Principal principal, HttpServletRequest request) {
		...
		try {
			this.pageNumber = (int) request.getSession().getAttribute("listMobileServiceProvider_pageNumber");
			this.totalPages = (int) request.getSession().getAttribute("listMobileServiceProvider_totalPages");
