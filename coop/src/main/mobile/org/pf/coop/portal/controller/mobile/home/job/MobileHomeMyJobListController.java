...
@Controller
@RequestMapping("/mobile/home/job")
public class MobileHomeMyJobListController extends MobileBaseController {
	...
	public String listJob(@PathVariable String whichPage, Model model, Principal principal, HttpServletRequest request) {
		...
		try {
			...
			if ("previous".equals(whichPage)) {
				if (pageNumber == 0) return "redirect:/mobile/home/job/list";
				else {
					pageNumber--; 
				}
