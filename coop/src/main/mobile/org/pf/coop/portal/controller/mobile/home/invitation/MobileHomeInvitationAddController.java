...
@Controller
@RequestMapping("/mobile/home/invitation/addNew")
public class MobileHomeInvitationAddController extends MobileBaseController {
	...
	public String invitationAdd(Model model) {
		...
		return "mobile/home/invitation/addNew";
	}
	...
	public String invitationAdd(@ModelAttribute Invitation invitation,
		...
		try {
			...
			if (tr == null) {
				...
				return "redirect:/mobile/home/invitation/list/current";
			} else if (tr.isStatus()){
